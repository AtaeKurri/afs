...
class afs_memory:
    def __init__(self, file):
        self.file = file
        self.key = Fernet(f"{open("key.txt", "r").read()}") # Replace the f_string to use your own fernet token
    ...
    def modify_values_helper(self, out_file):
        """
        Don't use this function in your program, it's only used here.
        """
    ...
    def write_json_to_afs(self, in_data, new_data):
        ...
        -----------
        in_data
            base dict (accessed by the j_load method)
    ...
    def delete_json_from_afs(self, in_data, del_data):
        ...
        del_data
            a path string for the deletion of the said keys in in_data.
            Must be in this format :
            Given this dict path : my_dict["a"]["b"]["c"]
            del_data must be this string : "a.b.c"
        """
